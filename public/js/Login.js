          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _services_AuthService__WEBPACK_IMPORTED_MODULE_1__.default.login(_this.form);
              ...
              case 5:
                ...
                if (authUser) {
                  ...
                  _this.snackbar.text = "Unable to fetch user after login, please check your API settings.";
              ...
              case 9:
                ...
                if (_context.t0.response.status === 422) {
                  _this.snackbar.text = _context.t0.response.data.errors.email[0];
                }
